        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? " rounded-md w-[20%] max-w-[20%] tablet2:w-[20%] tablet2:max-w-[20%] desktop1:w-[20%] transition-all duration-1000 "
                  : " my-[20px] w-[25%] tablet1:w-[30%] desktop1:w-[35%] transition-all duration-1000 "
              } tablet3:mb-0`}
            />
          </ScrollLink>
